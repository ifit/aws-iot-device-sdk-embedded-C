 ...
 * @details
 * Kades Work on Amazons iot network mbed tls stuff
 */
...
#ifndef ESP_MBED_CONFIG
#error "We need to be using the esp mbed config"
#endif //ESP_MBED_CONFIG

#ifndef ICON_THREADING_USED
#error "ICON_THREADING_USED not defined.  The wrong config is being used!!!"
#endif //ICON_THREADING_USED
/***********************************************************************************/
/***************************** Defines and Macros **********************************/
/***********************************************************************************/
                                                      ...
                                                      void * pContext )
{
    ...
    IotLogError("Calling IotNetworkMbedtls_SetCloseCallback");
